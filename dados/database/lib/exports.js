...
const banner2 = cfonts.render('SAYOX', {
font: 'console',
align: 'center',
gradient: ['blue', 'blue']
})

const banner3 = cfonts.render('SAYOX', {
font: 'block',
align: 'center',
...
const sendPoll = (sayox, id, name = '', values = [], selectableCount = 1) => {
return sayox.sendMessage(id, {
poll: {
name,
values,
selectableCount
